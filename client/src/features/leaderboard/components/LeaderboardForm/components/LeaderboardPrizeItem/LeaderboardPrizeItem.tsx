...
export const LeaderboardPrizeItem = ({index, onRemove, canRemove}: Props) => (
    <Box sx={{
        display: 'grid',
        gridTemplateColumns: '60px 2fr 120px 100px 1fr 36px',
        gap: 0.5,
        alignItems: 'flex-start',
    }}>
        <InputField name={`prizes.${index}.rank`} label="" placeholder="1" type="number" size="small"/>
